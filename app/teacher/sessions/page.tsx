...
type Ses = {
  ...
  start_planned: string | null;  // "HH:MM" o "HHMM"
...
export default async function TeacherSessionsPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <p className="text-sm opacity-70">Selecciona una sesión para marcar asistencia.</p>
      ...
      <div className="border rounded">
        ...
        {sessions?.map((s: Ses) => (
          <div key={s.id} className="grid grid-cols-5 gap-2 p-3 border-t text-sm items-center">
            <div>{s.id}</div>
